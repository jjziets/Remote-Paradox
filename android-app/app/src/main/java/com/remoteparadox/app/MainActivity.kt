            ...
            RemoteParadoxTheme {
                ...
                when (state.screen) {
                    ...
                    Screen.Settings -> SettingsScreen(
                        ...
                        piMaintenance = state.piMaintenance,
                        ...
                        onRefreshPiMaintenance = { vm.refreshPiMaintenanceStatus() },
                        ...
                        onPaiStop = { vm.paiStop() },
                        onPaiStart = { vm.paiStart() },
                        onPaiUpdatePassword = { vm.paiUpdatePassword(it) },
                        onBleLinkPi = { vm.goToBleFromSettings() },
                        watchSyncState = state.watchSync,
                        onSendToWatch = { vm.sendToWatch() },
                        watchUpdateState = state.watchUpdate,
                        onCheckWatchUpdate = { vm.checkWatchUpdate() },
                        onDownloadWatchUpdate = { vm.downloadAndSendWatchUpdate() },
                        onLogout = { vm.logout() },
                        onSwitchServer = { vm.switchServer() },
